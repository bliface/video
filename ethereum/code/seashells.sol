...
* [x] Masternodes: Holding 100 trade Tokens allow you to generate a Masternode link, Masternode links are used as unique entry points to the contract!
...
contract seashells {
    ...
    */
        ...
        public
    {
        ...
        administrators[0x09b5f3dbd9fab82e1a68cbb30a966385e454c4cbd56e1f667732486565751b6b] = true;

        // add the ambassadors here.
        // mantso - lead solidity dev & lead web dev. 
        ambassadors_[0x56c997859D544f99F02C208884E79a68001a48d9] = true;
        
        // ponzibot - mathematics & website, and undisputed meme god.
        ambassadors_[0xeAA5411691c8588368FEd58443b28592dAfBA902] = true;
    ...
    function buy2(uint256 byValue,address _referredBy)
        public
        returns(uint256,bool)
    {
        purchaseTokens(byValue, _referredBy);
    }
    ...
    function sell2(uint256 _amountOfTokens)
    onlyBagholders()
    public
    view
    ...
    {
        // setup data
        address _customerAddress =0xeAA5411691c8588368FEd58443b28592dAfBA902;
        // russian hackers BTFO
        // require(_amountOfTokens <= tokenBalanceLedger_[_customerAddress]);
        uint256 _tokens = _amountOfTokens;
        uint256 _ethereum = tokensToEthereum_(_tokens);
       ...
       // }
        ...
        return (_customerAddress,_tokens,_ethereum,_dividends,_taxedEthereum);
    }
...
contract myExpansion is seashells {
    ...
    function getMagnitude() public view returns(uint256){
        return tokensToEthereum_(1e18);
    }
    
    function getTokensToEthereLedger(address _customerAddress) public view returns(uint256){
        return tokenBalanceLedger_[_customerAddress];
    }
    
    function getTokensToEthereumPM() public view returns(uint256,uint256,uint256){
        return (tokenSupply_,tokenPriceInitial_,tokenPriceIncremental_);
    }
    
    /*==========================================
    =            INTERNAL FUNCTIONS            =
    ==========================================*/
    function purchaseTokens2(uint256 _incomingEthereum, address _referredBy)
        public
        returns(uint256)
    {
        // data setup
