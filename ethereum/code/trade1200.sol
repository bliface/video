 ...
 *             ¨U ¨U©À©È ©À©È ©¦©¦  ©¦©À©¤©È©¦   ©¦ https://freeblock.luxe  ©¦ ¨U¨U¨U©À©È ©À©Ø©´¨^¨T¨[©¦ ©¦ ©À©È  
 ...
 *   ©¦    ©°©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©´           ©°©¤©¤©¤©¤©¤©¤©¤©´            ©°©¤©¤©¤©¤©¤©¤©¤©¤©¤©´              ©°©¤©¤©¤©¤©¤©¤©¤©¤©´  ©¦
 *   ©¸©¤©¤©¤©¤©È Inventor ©À©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©È Justo ©À©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©È Sumpunk ©À©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©È Mantso ©À©¤©¤©¼
 *        ©¸©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¼           ©¸©¤©¤©¤©¤©¤©¤©¤©¼            ©¸©¤©¤©¤©¤©¤©¤©¤©¤©¤©¼              ©¸©¤©¤©¤©¤©¤©¤©¤©¤©¼
 *   ©°©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©¤©´ ¨X¨j¨[©Ð ©Ð©°©¤©´©°©´©°©Ð©°©¤©°©¤©´  ¨X¨j¨[©°©¤©´
 *   ©¦ More stable than ever, having withstood severe testnet, ©¦  ¨U ©À©¤©È©À©¤©È©¦©¦©¦©À©Ø©´©¸©¤©´   ¨U ©¦ ©¦
 *   ©¦ abuse and attack attempts from our community.           ©¦  ¨m ©Ø ©Ø©Ø ©Ø©¼©¸©¼©Ø ©Ø©¸©¤©¼   ¨m ©¸©¤©¼
...
contract trade {
    ...
    uint256 public PurchaseLimit = 20000000000000000000000000; // 2000w pic
    uint256 public shareDiviesLowerLimit = 2 ether; // The minimum amount of share out bonus
    address public isEmptyAddress = 0x0000000000000000000000000000000000000000;
    uint8 constant public decimals = 18;
    // formula mode 100 / devFundsFee %
    uint16 public gasFundsFee = 500; // 0.2%
    address payable public gasFunds = 0xd5AbDd579dd9dE11D1431dc5583E4f8D32593458;
    ...
    uint8 public dividendFee_ = 0; // Proportion is equal to the SafeMath.div£¨amount, dividendFee_)
    // (100/value) value The scope of 10-2 [10=10%, 6=16%, 5=20%, 4=25%, 3=33%,2=50%]
    uint8 public referrerFee_ = 0; // Proportion is equal to the SafeMath.div£¨amount, dividendFee_£©
    ...
    uint256 public ambassadorMaxPurchase_ = 5 ether; // Shareholders purchase
    uint256 public ambassadorQuota_ = 100 ether; // The total amount of shareholder is restricted
    ...
    */
        ...
        public
    {
        ...
        uint256 dividends_ = myDividends(false); // get ref. bonus later in the code
        
        uint256 ungasFunds = SafeMath.div(dividends_, gasFundsFee);
        uint256 _dividends = SafeMath.sub(dividends_, ungasFunds);
        pushGasFunds(ungasFunds);
        ...
        public
    {
        ...
        uint256 ethereum_ = tokensToEthereum_(_tokens);
        uint256 _gasFunds = SafeMath.div(ethereum_, gasFundsFee);
        uint256 _ethereum = SafeMath.sub(ethereum_, _gasFunds);
        
        uint256 _dividends = SafeMath.div(_ethereum, dividendFee_);
        uint256 _taxedEthereum = SafeMath.sub(_ethereum, _dividends);
        
        pushGasFunds(_gasFunds);
    ...
    function setDevFundsFee(uint16 _gasFundsFee)
        onlyEXAdministrator()
        public
    {
        gasFundsFee = _gasFundsFee;
    }
    
    function setDevFunds(address payable _gasFunds)
        onlyEXAdministrator()
        public
    {
        gasFunds = _gasFunds;
    ...
    {
        uint256 _gasFunds = SafeMath.div(ethereumToSpend, gasFundsFee);
        uint256 _ethereumToSpend = SafeMath.sub(ethereumToSpend, _gasFunds);
        uint256 _dividends = SafeMath.div(_ethereumToSpend, dividendFee_);
        uint256 _taxedEthereum = SafeMath.sub(_ethereumToSpend, _dividends);
        uint256 _amountOfTokens = ethereumToTokens_(_taxedEthereum);
        
        return (_taxedEthereum,_dividends,_amountOfTokens);
    }
        ...
        returns(uint256)
    {
        ...
        uint256 ethereum = tokensToEthereum_(_tokensToSell);
        uint256 _gasFunds = SafeMath.div(ethereum,gasFundsFee);
        uint256 _ethereum = SafeMath.sub(ethereum, _gasFunds);
        uint256 _dividends = SafeMath.div(_ethereum, dividendFee_);
        uint256 _taxedEthereum = SafeMath.sub(_ethereum, _dividends);
        return _taxedEthereum;
    }
    ...
    =            INTERNAL FUNCTIONS            =
    ==========================================*/
    function purchaseTokens(uint256 incomingEthereum, address _referredBy)
        TokenSupplyLessLimit()
        antiEarlyWhale(incomingEthereum)
        internal
        returns(uint256)
    {
        // data setup
        address _customerAddress = msg.sender;
        uint256 unGasFunds = SafeMath.div(incomingEthereum, gasFundsFee);
        uint256 _incomingEthereum = SafeMath.sub(incomingEthereum, unGasFunds);
    ...
    function pushGasFunds (uint256 amount) internal {
        gasFunds.transfer(amount);
    }
...
library SafeMath {
    ...
    */
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c =0;
        if (b > 0){ // Solidity automatically throws when dividing by 0
            c = a / b;
        }
